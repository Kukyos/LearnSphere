...
// Home Route Component - switches between Landing and LearnerHome based on auth
const HomeRoute: React.FC = () => {
  ...
  // If user is logged in, show courses page without hero
  if (user) {
    return <LearnerHome />;
  }

  // If not logged in, show full landing page with hero
  return <Landing />;
};
